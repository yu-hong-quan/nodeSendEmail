...
const local = "guandong/shenzheng";

//发送者邮箱厂家
let EmianService = "qq";
//发送者邮箱账户SMTP授权码
let EamilAuth = {
  user: "360151193@qq.com",
  pass: "uduhbhstofqnbhci"
};
//发送者昵称与邮箱地址
let EmailFrom = '"vince" <360151193@qq.com>';

//接收者邮箱地
let EmailTo = "15017872695@163.com";
//邮件主题
...
const  scheduleCronstyle = ()=>{
  //每分钟的第30秒定时执行一次:
    schedule.scheduleJob('30 * * * * *',()=>{  //6个占位符从左到右分别代表：秒、分、时、日、月、周几
